...
// const AreaOFIntrest = [
//     { label: 'E-commerce Platforms', value: 'E-commerce Platforms' },
...
//         setFormData({ ...formData, profile_pic_url: image });
//     };
...
//         toast.error(`${firstMissingField.replace('_', ' ')} is missing`);
//         return;
//     }

//     const fieldsToCheckLength = ['bio', 'startup_idea', 'startup_description'];
//     const shortFields = fieldsToCheckLength.filter(field => formData[field].length < 100);

//     if (shortFields.length > 0) {
//         toast.error(`${shortFields[0].replace('_', ' ')} must be at least 100 characters long`);
//         return;
//     }
...
//             setFormData(prevFormData => ({ ...prevFormData, profile_pic_url: uploadedImageUrl }));
//         } catch (error) {
...
//             error: (err) => <b>Failed to sign up: {err.username.toString()}</b>,
//         }
//     ).then((res) => {
//         setLoading(false);
//         setError('');
//     }).catch((err) => {
//         console.error('Error:', err.username);
...
//                 <h2 className="text-primary text-3xl font-bold mb-6">Create an Account</h2>
//                 <form
//                     onSubmit={handleSubmit}
//                     className='grid grid-cols-1 md:grid-cols-2 gap-3'
//                 >
//                     <div className="md:col-span-full flex flex-col justify-center items-center gap-2">
...
//                         <button
//                             type="submit"
//                             className='w-1/2 bg-primary text-white py-2 px-6 rounded-lg hover:text-primary hover:bg-white hover:border-2 hover:border-primary'
//                         >
//                             {loading ? 'Signing up...' : 'Sign Up'}
//                         </button>
//                     </div>
//                 </form>
//                 <p className="mt-4 text-sm text-gray-600">Already have an account? <Link to="/login" className="text-primary">Log in</Link></p>
//             </div>
//         </>
//     );
// };
